...
public class DeleteOfferPoints {
    ...
    private  String DeleteOfferPOURL = "http://gp.sendiancrm.com/offerall/deleteOfferPoints.php";

    Context context;

    public DeleteOfferPoints(Context context) {
    ...
    public  void deleteOfferDiscountDB(final int offerId){
        ...
        request =new StringRequest(Request.Method.POST, DeleteOfferPOURL, new Response.Listener<String>() {
            @Override
